...
<!-- ============================================================= HEADER : END ============================================================= -->		<div id="single-product">
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <div class="single-product-gallery-item" id="<?php echo $i ?>">
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                <?php $i = 2;?>
                <?php foreach ((array)json_decode($product['pics'],true)as $k=>$pic):?>
                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="<?php echo $i-1;?>" href="#slide1<?php echo $i?>">
    ...
    <div class="body">
        ...
        <div class="qnt-holder">
            ...
            <a id="addto-cart" href="<?php echo yii\helpers\Url::to(['cat/index']);?>" class="le-button huge">加入购物车</a>
        </div><!-- /.qnt-holder -->
    </div><!-- /.body -->
			...
			<div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
				...
				<div class="no-margin carousel-item product-item-holder size-small hover">
					<div class="product-item">
                        ...
                        <?php endif; ?>
						<div class="image">
							<img alt="<?php echo $pro->title ?>" src="<?php echo $pro->cover ?>-covermiddle" data-echo="a<?php echo $pro->cover ?>-covermiddle" />
						</div>
						<div class="body">
							<div class="title">
